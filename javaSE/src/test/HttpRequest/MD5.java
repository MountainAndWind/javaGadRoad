...
public class MD5 {
    ...
    public static void main(String[] args) {
        String token="Jn4ubvpsKm";
        String AppSecret="CnE2RSRTxau4PG8wYMFm3OBUcJgp77";
        String timestamp= GetUnixStarp.Date2TimeStamp(DateUtils.getDate(),"yyyyMMddHHmmss");
        String s1 = new MD5().encrypByMd5(token + AppSecret+"0");

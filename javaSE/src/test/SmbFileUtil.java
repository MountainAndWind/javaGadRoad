...
public class SmbFileUtil {
    ...
    public static void main(String[] args) throws Exception {
        String remark = "<p style=\"font-family:&#39;微软雅黑&#39;,&#39;Microsoft YaHei&#39;;font-size:12px;\"><span style=\"font-size: 12px; font-family: 微软雅黑;\">测试测试</span><br/></p>";
    ...
    public static List getSharedFileList(String remoteUrl) {
        ...
        try {
            ...
            if (!smbFile.exists()) {
                System.out.println("目录不存在！remoteUrl=" + remoteUrl);
            } else {
    ...
    public static String getSmbXMLContent(String remoteUrl) {
        ...
        try {
            ...
            System.out.println("共享文件不存在-remoteUrl=" + remoteUrl);
            var5 = "";
        } catch (Exception var16) {

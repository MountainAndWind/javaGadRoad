...
public class FtpUtils  {
    ...
    public boolean uploadFile(String pathname, String fileName, String originfilename) {
        ...
        try {
            ...
            System.out.println("FtpUtils-->uploadFile-->flag11::" + flag11);
            System.out.println("FtpUtils-->uploadFile-->pathname::" + pathname + fileName);
            boolean flag22 = this.ftpClient.changeWorkingDirectory(pathname);
            System.out.println("FtpUtils-->uploadFile-->flag22::" + flag22);
            this.ftpClient.enterLocalPassiveMode();
            System.out.println("FtpUtils-->uploadFile-->flag33...");
            boolean flag3 = this.ftpClient.storeFile(pathname + fileName, inputStream);
            System.out.println("FtpUtils-->uploadFile-->flag3::" + flag3);
            inputStream.close();
            boolean flag4 = this.ftpClient.logout();
            System.out.println("FtpUtils-->uploadFile-->flag4::" + flag4);
            flag = true;
    ...
    public boolean uploadFile(String pathname, String fileName, InputStream inputStream) {
        ...
        try {
            ...
            boolean flag1 = this.ftpClient.storeFile(new String(fileName.getBytes("utf-8"), "iso-8859-1"), inputStream);
            //boolean flag1 = this.ftpClient.storeFile(fileName, inputStream);
